(() => {
    var __webpack_modules__ = {
        ...
        "webpack/container/reference/cart_n": (e, r, _) => {
            ...
            e.exports = new Promise(((e, r) => {
                ...
                _.l("http://localhost:8001/remoteEntry.js", (_ => {
                    if ("undefined" != typeof cart) return e();
                    var i = _ && ("load" === _.type ? "missing" : _.type), n = _ && _.target && _.target.src;
                    a.message = "Loading script failed.\n(" + i + ": " + n + ")", a.name = "ScriptExternalLoadError", 
                    a.type = i, a.request = n, r(a);
                }), "cart");
            })).then((() => cart));
        },
        "webpack/container/reference/products_n": (e, r, _) => {
            ...
            e.exports = new Promise(((e, r) => {
                ...
                _.l("http://localhost:8002/remoteEntry.js", (_ => {
                    if ("undefined" != typeof products) return e();
                    var i = _ && ("load" === _.type ? "missing" : _.type), n = _ && _.target && _.target.src;
                    a.message = "Loading script failed.\n(" + i + ": " + n + ")", a.name = "ScriptExternalLoadError", 
                    a.type = i, a.request = n, r(a);
    ...
    }, __webpack_module_cache__ = {}, inProgress, dataWebpackPrefix, chunkMapping, idToExternalAndNameMapping;
    ...
    r)), [])), __webpack_require__.u = e => e + ".js", __webpack_require__.g = function() {
    ...
    inProgress = {}, dataWebpackPrefix = "container:", __webpack_require__.l = (e, r, _, a) => {
        if (inProgress[e]) inProgress[e].push(r); else {
            var i, n;
            if (void 0 !== _) for (var c = document.getElementsByTagName("script"), t = 0; t < c.length; t++) {
                var o = c[t];
            ...
            i || (n = !0, (i = document.createElement("script")).charset = "utf-8", i.timeout = 120, 
            __webpack_require__.nc && i.setAttribute("nonce", __webpack_require__.nc), i.setAttribute("data-webpack", dataWebpackPrefix + _), 
            i.src = e), inProgress[e] = [ r ];
            var onScriptComplete = (r, _) => {
                i.onerror = i.onload = null, clearTimeout(u);
                var a = inProgress[e];
                if (delete inProgress[e], i.parentNode && i.parentNode.removeChild(i), a && a.forEach((e => e(_))), 
                r) return r(_);
        ...
        "webpack/container/remote/products_n/index": [ "default", "./index", "webpack/container/reference/products_n" ]
    }, __webpack_require__.f.remotes = (e, r) => {
        __webpack_require__.o(chunkMapping, e) && chunkMapping[e].forEach((e => {
            ...
            if (!(_.indexOf(a) >= 0)) {
                ...
                }, onInitialized = (e, r, i) => handleFunction(r.get, a[1], _, 0, onFactory, i), onFactory = r => {
                    a.p = 1, __webpack_require__.m[e] = e => {
                        e.exports = r();
                    };
                };
                handleFunction(__webpack_require__, a[2], 0, 0, ((e, r, _) => e ? handleFunction(__webpack_require__.I, a[0], 0, e, onInitialized, _) : onError()), 1);
            }
        }));
    }, (() => {
        ...
        __webpack_require__.I = (_, a) => {
            ...
            if (i || (i = r[_] = {}), !(a.indexOf(i) >= 0)) {
                ...
                if ("default" === _) initExternal("webpack/container/reference/cart_n"), initExternal("webpack/container/reference/products_n");
        ...
        __webpack_require__.f.j = (r, _) => {
            ...
            if (0 !== a) if (a) _.push(a[2]); else {
                ...
                _.push(a[2] = i);
                var n = __webpack_require__.p + __webpack_require__.u(r), c = new Error;
                __webpack_require__.l(n, (_ => {
                    if (__webpack_require__.o(e, r) && (0 !== (a = e[r]) && (e[r] = void 0), a)) {
                        var i = _ && ("load" === _.type ? "missing" : _.type), n = _ && _.target && _.target.src;
                        c.message = "Loading chunk " + r + " failed.\n(" + i + ": " + n + ")", c.name = "ChunkLoadError", 
                        c.type = i, c.request = n, a[1](c);
                    }
                }), "chunk-" + r, r);
            }
        };
        var webpackJsonpCallback = (r, _) => {
            ...
            for (r && r(_); o < n.length; o++) i = n[o], __webpack_require__.o(e, i) && e[i] && e[i][0](), 
            e[i] = 0;
